...
export const GET: RequestHandler = async ({ params, locals, getClientAddress }) => {
	...
	const masterData = [
		...
		candidate.fatherName ?? '', candidate.fatherDob ?? '', candidate.fatherMobile ?? '',
		...
		candidate.emergencyContactName ?? '', candidate.emergencyContactMobile ?? '', candidate.emergencyContactRelation ?? '',
		'', '', '', '', '',
	...
	const summaryRows: Array<[string, string]> = [
		...
		['Father DOB', candidate.fatherDob ?? ''],
		...
		['Emergency Contact Name', candidate.emergencyContactName ?? ''],
		['Emergency Contact Mobile', candidate.emergencyContactMobile ?? ''],
		['Emergency Contact Relation', candidate.emergencyContactRelation ?? ''],
