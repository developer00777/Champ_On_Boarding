...
const samples = [
	{
		...
		offer: {
			...
			compensationAnnexure: {
				...
				ltaPm: '625',
				extraCash: [
					{ label: 'Performance Bonus in Advance', pm: '2500' },
					{ label: 'Special Allowances', pm: '2125' }
				],
				pfPm: '1500',
				gratuityPm: '600',
				insurancePm: '500',
	...
	},
	{
		...
		offer: {
			...
			compensationAnnexure: {
				...
				ltaPm: '1450',
				extraCash: [
					{ label: 'Performance Bonus in Advance', pm: '5800' },
					{ label: 'Shift Allowances', pm: '2000' },
					{ label: 'Special Allowances', pm: '5250' }
				],
				pfPm: '3480',
				gratuityPm: '1394',
				insurancePm: '1200',
